...
if(VGG_VAR_PLATFORM_TARGET STREQUAL "WASM"
  OR VGG_VAR_PLATFORM_TARGET MATCHES "^iOS")
    set(SKIA_LIB_LINK_TYPE "static")
endif()

set(SKIA_LIB_BUILD_PREFIX "out/${VGG_VAR_PLATFORM_TARGET}/${ENV_SHELL_PREFIX}/${CMAKE_CXX_COMPILER_ID}_${CMAKE_CXX_COMPILER_VERSION}/${SKIA_LIB_LINK_TYPE}/${CMAKE_BUILD_TYPE}" CACHE STRING "" FORCE)
