...
std::optional<ELayerError> VGGLayer::init(const LayerConfig& cfg)
{
  return std::nullopt;
}
void VGGLayer::dispatchEvent(LayerEvent event)
{
}
void VGGLayer::beginFrame()
{
}
void VGGLayer::render()
{
}
void VGGLayer::endFrame()
{
}
void VGGLayer::shutdown()
{
}
} // namespace VGG
