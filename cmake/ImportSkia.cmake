...
elseif(NOT IS_DIRECTORY ${SKIA_SOURCE_DIR})
  ...
  unset(SKIA_URL)
  unset(SKIA_ARCHIVE_MD5_CHECKSUM)
  string(JSON SKIA_URL GET ${DEPS_CONFIG} skia url)
  string(JSON SKIA_ARCHIVE_MD5_CHECKSUM GET ${DEPS_CONFIG} skia md5)
  if(NOT DEFINED SKIA_URL OR SKIA_URL STREQUAL "" OR NOT DEFINED SKIA_ARCHIVE_MD5_CHECKSUM OR SKIA_ARCHIVE_MD5_CHECKSUM STREQUAL "")
    message(FATAL_ERROR "Invalid skia url or md5")
  endif()
