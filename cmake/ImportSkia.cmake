...
set(SKIA_EXTERNAL_SOURCE_DIR "/home/ysl/Code/skia/")
set(SKIA_LIB_DIR "/home/ysl/Code/skia/out/Linux/Shared/DebugEGL")
set(SKIA_INCLUDE_DIRS "${SKIA_EXTERNAL_SOURCE_DIR}" "${SKIA_EXTERNAL_SOURCE_DIR}/include/")
set(SKIA_LIBS)
...
# set(_SKIA_SKIA_LIB "/home/ysl/Code/skia/out/Wasm/Release/libskia.a")
...
# set_target_properties(skia::${LIB_NAME} PROPERTIES
# IMPORTED_LOCATION ${_SKIA_SKIA_LIB}
# IMPORTED_LOCATION_DEBUG ${_SKIA_SKIA_LIB}
# IMPORTED_CONFIGURATIONS "RELEASE;DEBUG"
# )
