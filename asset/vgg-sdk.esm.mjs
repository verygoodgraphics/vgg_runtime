...
function vggGetObject(key) {
  var value = vggGetEnvContainer().get(key);
  return value;
}
...
function setVgg(_x2) {
  return _setVgg.apply(this, arguments);
}
function _setVgg() {
  _setVgg = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(value) {
    var container;
